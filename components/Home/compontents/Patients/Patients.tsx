...
export default function Patients() {
  ...
  const cardsData = [
    ...
    },
    {
      ...
      description: '',
      image: (
        <IconBarbell color="#4261AA" stroke={0.5} style={{ width: rem(80), height: rem(80) }} />
      ),
    },
    {
    ...
    },
    {
      ...
      description: '',
      image: (
        <IconCookie color="#4261AA" stroke={0.5} style={{ width: rem(80), height: rem(80) }} />
      ),
    },
    {
      ...
      image: (
        <IconPaperBag color="#4261AA" stroke={0.5} style={{ width: rem(80), height: rem(80) }} />
      ),
    },
    {
